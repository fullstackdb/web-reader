...
document.addEventListener('DOMContentLoaded', function () {
  ...
  console.log('ext', document.getElementsByClassName('read__btn')[0], ReaderArticleFinder);
  document.getElementsByClassName('read__btn')[0].addEventListener('click', function () {
    console.log('btn clicked', ReaderArticleFinder);
